...
// <img :src="img" alt="Some img" class="productBasketImg">
//     <div class="productBasketPar">
//       <h3 class="productBasketTitle">{{ cartItemEl.product_name }}</h3>
//       <p class="productBasketPrice">Цена: {{ cartItemEl.price }}</p>
//       <p>Количество: {{ cartItemEl.quantity }}</p>
//       <h4>Cумма: {{cartItemEl.quantity * cartItemEl.price}} </h4>
//     </div> 
//     <button class="productBasketRemove" @click="$parent.cart.remove(cartItemEl)">x</button>
// </div>
